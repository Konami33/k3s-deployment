...
This workflow will install the *self hosted* Git-runner, *Ansible* in Git-runner instance. Making it **Control node** for Ansible Automation.
    ...
    steps:
      ...
      - name: SSH to Runner EC2 and install GitHub Runner and Ansible
        run: |
          ...
          ./config.sh --url https://github.com/Konami33/k3s-deployment --token AQGGSGTLFAJGHZVSWV4XCZTGQRIEO --name "Git Runner"
